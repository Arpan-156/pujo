    ...
    <section ref={ref} className="manifesto">
      ...
      <div className="wrap mf-grid">
        ...
        <div className="mf-imgs">
          <div className="mf-a"><Photo v={{ art: 'idol', seed: 32, hue: 8, tone: 'dusk', src: '/photos/durga.jpg' }} alt="A Durga idol" /></div>
          <div className="mf-b"><Photo v={{ art: 'dhak', seed: 33, hue: 24, tone: 'dawn', src: '/photos/radio.jpg' }} alt="Radio and Mahalaya mask" /></div>
          <div className="mf-c"><Photo v={{ art: 'gate', seed: 34, hue: 14, tone: 'dusk', src: '/photos/gate.jpg' }} alt="Dhakis at sunset" /></div>
        </div>
      </div>
    </section>
  );
