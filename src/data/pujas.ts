...
const ROWS: Row[] = [
  ...
  { slug: 'amadpur-zomidar-bari', name: 'Amadpur Zomidar Bari', area: 'Amadpur', town: false, themeId: 'heritage', themeName: 'A Timeless Legacy', cats: ['Family Puja', 'Heritage'], est: 1650, feat: false, art: 'pandal', seed: 123, hue: 15, tone: 'night', x: 85, y: 85, desc: 'Experience the grandeur of a heritage Durga Puja, preserving centuries of devotion and tradition at the historic Amadpur Zomidar Bari.' }
];
